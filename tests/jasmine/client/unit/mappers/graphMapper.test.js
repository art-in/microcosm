    ...
    (graphMapper, Mindmap, Idea, Assoc) => {
      ...
      describe('graphMapper', () => {
        ...
        describe('toGraph', () => {
          ...
          it('should map to right number of nodes', () => {
            mindmap.ideas = [new Idea()];
            let graph = toGraph(mindmap);
            expect(graph.nodes.length).toBe(1);
          });

          it('should map to right number of links', () => {
            let idea1 = new Idea();
            let idea2 = new Idea();
          ...
          it('should color links with color of BOI', () => {
            ...
            mindmap.assocs = [boi1Assoc, boi2Assoc,
                              boi2Sub1Assoc, boi2Sub2Assoc];
            ...
            expect(boi1Link.color).toEqual('red');
            expect(boi2Link.color).toEqual('blue');
            expect(boi2Sub1Link.color).toEqual('blue');
            expect(boi2Sub2Link.color).toEqual('blue');
          });
